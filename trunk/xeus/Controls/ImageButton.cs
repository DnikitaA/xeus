...
namespace xeus.Controls
{
	...
	public class ImageButton : Button
	{
		...
		public string ImageOver
		{
			get
			{
				return ( string ) GetValue( ImageOverProperty ) ;
			}
			set
			{
		...
		public string ImageNormal
		{
			get
			{
				return ( string ) GetValue( ImageNormalProperty ) ;
			}
			set
			{
				SetValue( ImageNormalProperty, value ) ;
			}
		}
		...
		public string ImageDown
		{
			get
			{
				return ( string ) GetValue( ImageDownProperty ) ;
			}
			set
			{
				SetValue( ImageDownProperty, value ) ;
			}
		}
